...
const HeroSection = () => {
  ...
  return (
    <section className="w-full min-h-screen bg-white flex flex-col">
      ...
      {/* Hero Section */}
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-6 md:px-20 py-16">
        {/* Left Side */}
      ...
      <div className="w-full bg-gray-100 py-6 flex flex-wrap justify-center space-x-6 md:space-x-10">
